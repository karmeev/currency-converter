...
namespace Currency.Services.Tests.Utility;
...
public static class Test
{
    ...
    public static void CompleteWithFailTest([CallerFilePath] string file = "Caller",
        [CallerMemberName] string name = "Unverified test")
    {
        TestContext.Progress.WriteLine($"Failed test ({GetClass(file)}): {name}");
        TestContext.Progress.WriteLine("\nOutput\n-------------");
    }
